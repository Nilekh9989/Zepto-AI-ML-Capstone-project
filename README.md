...
Data pipeline: scraping, cleaning, normalization, and relational storage. See data_pipeline/README.md.
Analytics pipeline: Titanic profiling, EDA, model building, and regression. See analytics/README.md.
Support assistant: a local RAG service for Zepto policy questions. See support_assistant/README.md.
